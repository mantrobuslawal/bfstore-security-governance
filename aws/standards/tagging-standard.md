...
Define required tags for cost, ownership, access review and automation.
...
- Required tags: Project, Environment, Service, Owner, ManagedBy, DataClass, CostCentre.
- Tags support ABAC and FinOps where practical.
