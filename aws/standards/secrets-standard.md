...
Define how secrets are created, consumed, rotated and audited.
...
- Applications consume secrets through workload identity.
- Secrets access is scoped per service/environment.
