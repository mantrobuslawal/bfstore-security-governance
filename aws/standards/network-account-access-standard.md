# Network Account Access Standard
...
Define access standards for the Network account.
...
- Network changes require PR review.
- TGW and route table changes are high-risk.
- Network account does not host app workloads.
