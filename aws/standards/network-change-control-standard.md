# Network Change Control Standard
...
Define review requirements for network changes.
...
- Route, TGW, DNS and firewall changes include blast-radius notes.
- Prod connectivity changes are tested outside prod first.
