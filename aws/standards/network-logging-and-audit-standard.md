# Network Logging And Audit Standard
...
Define network audit expectations.
...
- Enable logging where useful.
- Review route and firewall changes.
- Keep evidence for critical network changes.
