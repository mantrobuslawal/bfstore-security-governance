...
Find and remove stale or unused access.
...
- Review IAM last accessed data.
- Use Access Analyzer unused access findings.
- Retire stale roles and permissions.
